...
//	      System.out.println("nb = " + nb + ", width = " + width + ", n = " + n);
	...
	/**
	 * Returns the set of bags each represented as a bit set
	 * @return the set of bags
	 */
  ...
  /**
   * Returns the set of separators each represented as a bit set
  ...
  /**
   * Rerutn the tree of this tree-decompositoin as a graph
   * Vertex 0 of this graph representation is dummy
  ...
  /**
   * Returns the bag at index b as a bit set
   * @param b bag index
   * @return the bag at index b
   */
  ...
  /**
   * Returns the union of the bags with index in the given index set
   * @param ns index set
   * @return the union as a bit set
   */
  ...
  /**
   * Prints details of the tree decomposition to the console.
   */
  public void printDecomposition() {
    System.out.println("Tree Decomposition Details:");
    System.out.println("Number of Bags: " + nb);
    System.out.println("Treewidth: " + width);
    System.out.println("Number of Vertices in Graph: " + g.n);

    // Print details of each bag
    for (int i = 1; i <= nb; i++) {
      System.out.print("Bag " + i + ": { ");
      for (int v : bags[i]) {
        System.out.print(v + " ");
    ...
    // Print edges between bags
    System.out.println("Tree Edges:");
    for (int i = 1; i <= nb; i++) {
      for (int j : neighbor[i]) {
        if (i < j) { // Avoid duplicates
          System.out.println("Bag " + i + " -- Bag " + j);
        }
      }
    }

    // Print validation of connectivity and properties
    System.out.println("\nValidation Results:");
    try {
      validate();
